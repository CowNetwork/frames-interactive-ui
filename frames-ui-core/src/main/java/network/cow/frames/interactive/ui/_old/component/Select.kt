...
class Select(position: Point, dimensions: Dimension, private val options: Array<String>) : Group(position, dimensions) {
    ...
    init {
        ...
        this.leftButton.textComponent.delayPerPixel = 0.0
        this.leftButton.onActivate = { forward() }

        this.textDisplay.textComponent.delayPerPixel = 45.0
        this.textDisplay.onActivate = { forward() }

        this.rightButton.textComponent.delayPerPixel = 0.0
